...
_SQL_UPSERT = """
INSERT INTO resumen_ventas_consolidado (
    periodo_inicio, periodo_fin, sucursal_id, sucursal_nombre, pais_nombre,
    total_ventas, total_pedidos, clientes_activos
) VALUES (
    %(periodo_inicio)s, %(periodo_fin)s, %(sucursal_id)s,
    %(sucursal_nombre)s, %(pais_nombre)s,
...
def main():
    hoy = date.today()
    p = argparse.ArgumentParser(description="Fill resumen_ventas_consolidado")
