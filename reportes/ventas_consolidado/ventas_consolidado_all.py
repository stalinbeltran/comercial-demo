"""
reportes/ventas_consolidado/ventas_consolidado_all.py
Gestiona el ciclo completo del reporte 1.1 — Resumen de ventas consolidado.

Uso:
    python reportes/ventas_consolidado/ventas_consolidado_all.py
    python reportes/ventas_consolidado/ventas_consolidado_all.py --fill-only
    python reportes/ventas_consolidado/ventas_consolidado_all.py --drop
    python reportes/ventas_consolidado/ventas_consolidado_all.py --create
    python reportes/ventas_consolidado/ventas_consolidado_all.py --desde 2025-01-01 --hasta 2025-12-31
"""
...
SQL_DESNORM = os.path.join(_DIR, "create_ventas_consolidado.sql")
SQL_AGG     = os.path.join(_DIR, "create_resumen_ventas_consolidado.sql")

FILL_DESNORM = os.path.join(_DIR, "fill_ventas_consolidado.py")
FILL_AGG     = os.path.join(_DIR, "fill_resumen_ventas_consolidado.py")
